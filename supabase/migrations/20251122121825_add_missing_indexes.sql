CREATE INDEX projects_workspace_idx ON public.projects USING btree (workspace);

CREATE INDEX task_statuses_workspace_idx ON public.task_statuses USING btree (workspace);

CREATE INDEX tasks_workspace_idx ON public.tasks USING btree (workspace);
