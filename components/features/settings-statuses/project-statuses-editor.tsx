...
export default function ProjectStatusesEditor({
  ...
  const { execute, isExecuting } = useAction(upsertProjectStatusesAction, {
    onExecute: () => {
    ...
    onError: ({ error }) => {
      toast.error(error.serverError || "Failed to save statuses", {
        id: "save-statuses",
      });
    },
    onSuccess: () => {
    ...
    <div className="flex flex-col gap-6">
      <div className="flex flex-col rounded-lg bg-muted p-0.5">
        <div className="flex items-center justify-between p-2.5">
          <h2 className="font-semibold tracking-tight">Project statuses</h2>
