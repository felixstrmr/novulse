...
export function InboxIcon(props: Props) {
  return (
    ...
    >
      ...
      <g fill="currentColor">
        <path d="M16.213,9h-4.463c-.414,0-.75,.336-.75,.75v1c0,.138-.112,.25-.25,.25h-3.5c-.138,0-.25-.112-.25-.25v-1c0-.414-.336-.75-.75-.75H1.787c-.36,0-.668,.255-.736,.608-.033,.171-.05,.345-.05,.521v3.121c0,1.517,1.233,2.75,2.75,2.75H14.25c1.517,0,2.75-1.233,2.75-2.75v-3.121c0-.176-.017-.35-.05-.521-.068-.353-.376-.608-.736-.608Z" />
